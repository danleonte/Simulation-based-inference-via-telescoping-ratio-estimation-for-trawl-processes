...
def validate_classifiers(folder_path):    
    ...
    dataset_path = os.path.join(os.path.dirname(folder_path),  'cal_dataset')
...
if __name__ == '__main__':
    ...
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\NRE_full_trawl\uncalibrated')
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\NRE_full_trawl\beta_calibrated')
    
    #for subfolder in ['acf','beta','mu','sigma']:
    #    for cal in ['uncalibrated','beta_calibrated']:
            
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\acf\uncalibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\beta\uncalibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\mu\uncalibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\sigma\uncalibrated') 
    
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\acf\beta_calibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\beta\beta_calibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\mu\beta_calibrated') 
    folder_paths.append(r'D:\sbi_ambit\SBI_for_trawl_processes_and_ambit_fields\models\classifier\TRE_full_trawl\sigma\beta_calibrated') 
